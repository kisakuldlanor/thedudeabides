...
def SKindex():
    addon_log("SKindex")
    addDir('[B][COLOR lime]Maverick Movie Search[/B][/COLOR]','http://mavericktv.esy.es/data/quality/quality.txt',41,'http://previews.123rf.com/images/markinv/markinv1212/markinv121200020/17010740-All-seeing-eye-Stock-Vector-horus-eye-egyptian.jpg' ,  FANART,'','','','')
