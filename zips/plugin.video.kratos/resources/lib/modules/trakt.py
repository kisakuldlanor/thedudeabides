...
def getTrakt(url, post=None):
    try:
        ...
        headers = {'Content-Type': 'application/json', 'trakt-api-key': 'f7f624a1af5e94fae32b24aa1049a5612381e8865f24cd2476a79a91189a135c', 'trakt-api-version': '2'}
        ...
        opost = {'client_id': 'f7f624a1af5e94fae32b24aa1049a5612381e8865f24cd2476a79a91189a135c', 'client_secret': '89982502b0303e2a3d8d83890193775eee14b2ea76f1b70a21b0bb068f9493f6', 'redirect_uri': 'urn:ietf:wg:oauth:2.0:oob', 'grant_type': 'refresh_token', 'refresh_token': control.setting('trakt.refresh')}
...
def authTrakt():
    try:
        ...
        result = getTrakt('/oauth/device/code', {'client_id': 'f7f624a1af5e94fae32b24aa1049a5612381e8865f24cd2476a79a91189a135c'})
        result = json.loads(result)
        ...
        for i in range(0, expires_in):
            try:
                ...
                r = getTrakt('/oauth/device/token', {'client_id': 'f7f624a1af5e94fae32b24aa1049a5612381e8865f24cd2476a79a91189a135c', 'client_secret': '89982502b0303e2a3d8d83890193775eee14b2ea76f1b70a21b0bb068f9493f6', 'code': device_code})
                r = json.loads(r)
        ...
        headers = {'Content-Type': 'application/json', 'trakt-api-key': 'f7f624a1af5e94fae32b24aa1049a5612381e8865f24cd2476a79a91189a135c', 'trakt-api-version': '2', 'Authorization': 'Bearer %s' % token}
