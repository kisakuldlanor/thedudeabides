...
icon1 = os.path.join(home, 'Images', 'xml.jpg')
icon2 = os.path.join(home, 'Images', 'communityfiles.jpg')
icon3 = os.path.join(home, 'Images', 'kodi-addons.jpg')
icon4 = os.path.join(home, 'Images', 'favorites.png')
# art = xbmc.translatePath(os.path.join('special://home/addons/' + addon_id + '/resources/art/'))
# icon = xbmc.translatePath(os.path.join('special://home/addons/' + addon_id, 'icon.png'))
#fanart = xbmc.translatePath(os.path.join('special://home/addons/' + addon_id , 'fanart.jpg'))
FANART = os.path.join(home, 'fanart.jpg')
FANART4 = os.path.join(home, 'Images', 'favorites.png')
FANART2 = os.path.join(home, 'Images', 'communityfiles.jpg')
FANART3 = os.path.join(home, 'Images', 'kodi-addons.jpg')
FANART1 = os.path.join(home, 'Images', 'xml.jpg')
...
communityfiles = os.path.join(home, 'LivewebTV')
...
def getSources():
        try:
            ...
            if addon.getSetting("browse_xml_database") == "true":
                addDir('XML Database','https://raw.githubusercontent.com/twlizer/plugin.video.anonymous/master/Anonymous.xml',15,icon1,FANART1,'','','','')
            if addon.getSetting("browse_community") == "true":
                addDir('Community Files','community_files',16,icon2,FANART2,'','','','')
            if addon.getSetting("searchotherplugins"):
                addDir('[COLOR blue]Local Addons[/COLOR]','Search Plugins',25,icon3,FANART3,'','','','')
            if addon.getSetting("adultotherplugins"):
                addDir('[COLOR blue]Adult Addons[/COLOR]','Adult Plugins',26,icon3,FANART3,'','','','')
            if os.path.exists(source_file)==True:
...
def get_xml_database(url, browse=False):
        if url is None:
            url = 'https://raw.githubusercontent.com/twlizer/plugin.video.anonymous/master/Anonymous.xml'
        ...
        if url.startswith('http://') or url.startswith('https://'):
            ...
            if xbmcvfs.exists(url):
                if url.startswith("smb://") or url.startswith("nfs://"):
                    copy = xbmcvfs.copy(url, os.path.join(home, 'temp', 'sorce_temp.txt'))
                    if copy:
                        data = open(os.path.join(home, 'temp', 'sorce_temp.txt'), "r").read()
                        xbmcvfs.delete(os.path.join(home, 'temp', 'sorce_temp.txt'))
                    else:
...
#                        print 'cookieJar from file',cookieJar
                        ...
                        complete_path=os.path.join(home,cookie_jar_file)
...
def saveCookieJar(cookieJar,COOKIEFILE):
    try:
        complete_path=os.path.join(home,COOKIEFILE)
...
#        print 'captcha_url',captcha_url
        ...
        local_captcha = os.path.join(home,str(n) +"captcha.img" )
...
#    print expre,captcha_regex,captcha_url
    ...
    local_captcha = os.path.join(home, str(iid)+"captcha.jpg" )
    localFile = open(local_captcha, "wb")
...
def xsearch(url,name):
   # print url,name
    pluginsearchurls = ['plugin://plugin.video.videodevil',\
             'plugin://plugin.video.uwc',\
             'plugin://plugin.video.you.jizz',\
             'plugin://plugin.video.woodrocket',\
             'plugin://plugin.video.jizzplanet',\
             'plugin://plugin.video.javstream',\
             'plugin://plugin.video.cherrypie',\
             'plugin://plugin.video.dclip',\
             'plugin://plugin.video.empflix',\
             'plugin://plugin.video.erotik',\
             'plugin://plugin.video.fantasticc',\
             'plugin://plugin.video.hotgoo',\
			 'plugin://plugin.video.largecamtube',\
			 'plugin://plugin.video.likuoo',\
			 'plugin://plugin.video.lubetube',\
			 'plugin://plugin.video.xhamster',\
			 'plugin://plugin.video.xvideos',\
			 'plugin://plugin.video.sirinatv',\
			 'plugin://plugin.video.tube8',\
			 'plugin://plugin.video.tubesex',\
			 'plugin://plugin.video.oxo',\
			 'plugin://plugin.video.pornhub',\
			 'plugin://plugin.video.motherless',\
			 'plugin://plugin.video.korea-xxx',\
			 'plugin://plugin.video.adult.3xz',\
			 'plugin://plugin.video.beeg.com',\
			 'plugin://plugin.video.beegcom',\
			 'plugin://plugin.video.eporner',\
			 'plugin://plugin.video.ero-tik',\
			 'plugin://plugin.video.hstube',\
			 'plugin://plugin.video.wildfire'\
             ]
    names = ['Video Devil','UWC','You jizz','Wood Rocket','Jizz Planet','Jav Stream','Cherry Pie',\
             'Dclip','EMP Flix','EroTik','Fantastic','Hotgoo','Large CamTube','Likuoo','LubeTube','Xhamster','XVideo','SiranaTV','Tube8','TubeSex','OXO','PornHub','Motherless','Korea-XXX','Adult 3xz','Beeg 1','Beeg 2','Eporner','Ero-Tik','HS Tube','Wildfire']
    dialog = xbmcgui.Dialog()
    index = dialog.select('Choose a video source', names)
...
#            ln+='</item>'
    ...
    addon_log("Adult Other plugins")
    xsearch(url,name)
    xbmcplugin.endOfDirectory(int(sys.argv[1]))
elif mode==27:
    addon_log("adultotherplugins")
    addSource(url)
elif mode==55:
