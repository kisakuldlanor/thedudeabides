...
def getCacheSize():
	...
	dbfiles   = [
		(os.path.join(ADDONDATA, 'plugin.video.kratosfucksducky', 'cache.db')),
	...
	if INCLUDEVIDEO == 'true':
		...
		if INCLUDEALL == 'true': files = dbfiles
			...
			if INCLUDEKRATOS == 'true':  files.append(os.path.join(ADDONDATA, 'plugin.video.kratosfucksducky', 'cache.db'))
