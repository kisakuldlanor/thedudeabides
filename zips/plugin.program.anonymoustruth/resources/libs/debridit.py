...
ORDER          = ['kratos','exodus', 'specto', 'url']

DEBRIDID = { 
	'kratos': {
		'name'     : 'Kratos',
		'plugin'   : 'plugin.video.kratosfucksducky',
		'saved'    : 'realkratos',
		'path'     : os.path.join(ADDONS, 'plugin.video.kratosfucksducky'),
		'icon'     : os.path.join(ADDONS, 'plugin.video.kratosfucksducky', 'icon.png'),
		'fanart'   : os.path.join(ADDONS, 'plugin.video.kratosfucksducky', 'fanart.jpg'),
		'file'     : os.path.join(REALFOLD, 'kratosfucksducky_debrid'),
		'settings' : os.path.join(ADDOND, 'plugin.video.kratosfucksducky', 'settings.xml'),
		'default'  : 'realdebrid.id',
		'data'     : ['realdebrid.auth', 'realdebrid.id', 'realdebrid.secret', 'realdebrid.token', 'realdebrid.refresh'],
		'activate' : 'RunPlugin(plugin://plugin.video.kratosfucksducky/?action=rdAuthorize)'},
	'exodus': {
		'name'     : 'Exodus',
